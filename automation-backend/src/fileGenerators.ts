  ...
  return {
    files: [
      ...
      },
      {
        ...
        content: j({
          slug, clientName,
          generatedBy: "immersphere-production-orchestrator-v0.3",
          assetMode,
          files: [
    ...
    files: [
      {
        ...
        content: buildClientDemoData({ slug, camelBase, componentBase, clientName, sector, zone, website, logoUrl, heroImage, propertyImages, videoUrl, primaryColor, accentColor, waHref, telHref, emailHref, claim }),
...
function buildBannerConfig({ clientName, slug, logoUrl, heroImage, primaryColor, accentColor, waHref, claim }) {
  return `// Banner config for ${safeText(clientName)} — auto-generated by immersphere-production-orchestrator v0.3
...
function buildBannerEngine(): string {
  return `// Stable banner engine adapter — immersphere v0.3
(function(){
...
<body>
  <h1>${safeText(clientName)}</h1>
  <p class="sub">Banner Pack — Immersphere v0.3</p>
  <div class="sec">
...
function buildClientDemoData({ slug, camelBase, componentBase, clientName, sector, zone, website, logoUrl, heroImage, propertyImages, videoUrl, primaryColor, accentColor, waHref, telHref, emailHref, claim }) {
  ...
  return `// Auto-generated by immersphere-production-orchestrator v0.3
